...
const SidebarItem = React.memo(({ item, isActive, onSelect, onDelete }: SidebarItemProps) => {
...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <aside className="fixed inset-y-0 left-0 z-50 md:relative md:z-20 w-72 h-full bg-[#12131c] border-r border-zinc-800/80 flex flex-col justify-between shrink-0 overflow-hidden text-zinc-200 select-none animate-in slide-in-from-left-4 duration-200 shadow-2xl md:shadow-none">
                ...
                <div className="shrink-0">
                  {user.avatar ? (
                    <Image
                      ...
                      unoptimized={user.avatar.includes('googleusercontent')}
                    />
                  ) : (
